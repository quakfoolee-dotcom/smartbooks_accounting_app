...
// Loaded by frontend/index.html in dependency order.
  ...
  function injectEstimateToPaymentWorkflowStyles(){
    ...
    style.textContent=`
      ...
      body.dark-mode .estimate-payment-card,body.v8-ui.dark-mode .estimate-payment-card{background:#14202d!important;border-color:#2a3c4f!important}
      body.dark-mode .estimate-payment-stat,body.dark-mode .estimate-payment-step,body.dark-mode .estimate-payment-followup,body.v8-ui.dark-mode .estimate-payment-stat,body.v8-ui.dark-mode .estimate-payment-step,body.v8-ui.dark-mode .estimate-payment-followup{background:#101b27!important;border-color:#2a3c4f!important;color:#e8edf3!important}
      body.dark-mode .estimate-payment-step.attention,body.v8-ui.dark-mode .estimate-payment-step.attention{background:#2b2116!important;border-color:#8a5a22!important}
      body.dark-mode .estimate-payment-step.done,body.v8-ui.dark-mode .estimate-payment-step.done{background:#10271b!important;border-color:#2f6845!important}
      body.dark-mode .estimate-payment-head h3,body.dark-mode .estimate-payment-step strong,body.dark-mode .estimate-payment-stat strong,body.dark-mode .estimate-payment-followup strong,body.v8-ui.dark-mode .estimate-payment-head h3,body.v8-ui.dark-mode .estimate-payment-step strong,body.v8-ui.dark-mode .estimate-payment-stat strong,body.v8-ui.dark-mode .estimate-payment-followup strong{color:#f8fafc!important}
      body.dark-mode .estimate-payment-head p,body.dark-mode .estimate-payment-step small,body.dark-mode .estimate-payment-stat span,body.dark-mode .estimate-payment-followup span,body.v8-ui.dark-mode .estimate-payment-head p,body.v8-ui.dark-mode .estimate-payment-step small,body.v8-ui.dark-mode .estimate-payment-stat span,body.v8-ui.dark-mode .estimate-payment-followup span{color:#cbd5e1!important}
      body.dark-mode .estimate-payment-step:after,body.v8-ui.dark-mode .estimate-payment-step:after{color:#7f91a6!important}
      body.dark-mode .estimate-payment-icon,body.v8-ui.dark-mode .estimate-payment-icon{background:#0f172a!important;border-color:#8ecae6!important;color:#e6f6ff!important}
      body.dark-mode .estimate-payment-step.attention .estimate-payment-icon,body.v8-ui.dark-mode .estimate-payment-step.attention .estimate-payment-icon{border-color:#f59e0b!important;color:#ffd39a!important}
      body.dark-mode .estimate-payment-step.done .estimate-payment-icon,body.v8-ui.dark-mode .estimate-payment-step.done .estimate-payment-icon{border-color:#22c55e!important;color:#86efac!important}
